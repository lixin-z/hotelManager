...
<div class="place">
    ...
    <ul class="placeul">
        ...
        <li><a href="javaScript:viod(0)">修改客房信息</a></li>
    </ul>
</div>
...
<div class="formbody">
    ...
    <div id="usual1" class="usual">
        ...
        <div class="itab">
            <ul>
                <li><a href="#tab1" class="selected">修改客房</a></li>
            </ul>
        </div>
        ...
        <div id="tab1" class="tabson">
            ...
            <div class="formtext">
                Hi，<b>${sessionScope.username }</b>，请修改客房信息
            </div>

            <form id="fm1" action="<%=basePath%>/updateRoomInfo.do" method="POST">
                <ul class="forminfo">

                    <li>
                        <select id="selectRoomNum" name="oldRoomNum" class="select1">
                            <option value="0">请选择原房间号</option>
                            <c:forEach items="${sessionScope.roomInfo}" var="room">
                    ...
                    <li>
                        <label>房间号<b>*</b></label>
                        <input style="float:left;margin-bottom:10px" required="required" name="roomNum" type="text"
                               class="dfinput" id="name" placeholder="4位数字"/>
                        <label id="roomNumError" style="width:150px;color:red;float:left;margin-left:20px"></label>
                    </li>
                    <li>
                        <label>房间类型<b>*</b></label>
                        <div class="vocation">
                            <select name="roomTypeId" id="roomType" class="select1">
                            </select>
                        </div>
                        <div id="notice2"
