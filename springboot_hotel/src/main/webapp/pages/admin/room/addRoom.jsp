...
<body>
	...
	<div class="place">
		...
		<ul class="placeul">
			...
			<li><a href="javaScript:viod(0)">添加客房</a></li>
		</ul>
	</div>
			...
			<div id="tab1" class="tabson">
				...
				<form id="fm1" action="<%=basePath%>/addRoom.do" method="POST">
					<ul class="forminfo">
						<li>
							<label>房间号<b>*</b></label>
							<input style="float:left;margin-bottom:10px" required="required"  name="roomNum" type="text" class="dfinput" id="name" placeholder="4位数字"/>
