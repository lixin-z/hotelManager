...
<div class="rightinfo">
    ...
    <table class="tablelist">
        ...
        <tbody>
        <c:forEach items="${requestScope.roomInfo }" var="map" varStatus="num">
            <tr>
    ...
    $(function () {
        ...
        $("#condition").change(function () {
            ...
            if (flag == 1) {//房间类型
                ...
                $("#kw>option").remove();
                $("#kw").append("<option>请选择</option><option value='0'>空闲</option><option value='1'>已入住</option><option value='2'>打扫</option>");
            }
        });
    });
